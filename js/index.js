...
function renderCards() {
    ...
    data.forEach((book, index) => {
        const card = `
        <div class="bg-white border border-transparent rounded-2xl w-full px-3 py-3 hover:shadow-[0px_4px_20px_0px_rgba(0,0,0,0.2)] transition-all duration-300">
            ...
            <div class="p-5 space-y-3">
                ...
                <div class="flex justify-between items-center pt-2 h-[65px]">
